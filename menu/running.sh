...
green() { echo -e "\\033[32;1m${*}\${NCT}"; }
red() { echo -e "\\033[31;1m${*}\${NCT}"; }
clear
...
echo -e ""
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NCT}"
echo -e "${LIGHT}               SERVER INFORMATION                ${NCT}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NCT}"
echo -e "${cyan} Hostname  ${NCT}: $HOSTNAME"
echo -e "${cyan} OS Name   ${NCT}: $Tipe"
echo -e "${cyan} Total RAM ${NCT}: ${totalram} MB"
echo -e "${cyan} Public IP ${NCT}: $MYIP"
echo -e "${cyan} Domain    ${NCT}: $Domen"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NCT}"
echo -e "${LIGHT}              SERVICE INFORMATION                ${NCT}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NCT}"
echo -e "${cyan} SSH / TUN            ${NCT}: $status_ssh"
echo -e "${cyan} Dropbear             ${NCT}: $status_beruangjatuh"
echo -e "${cyan} Stunnel4             ${NCT}: $status_stunnel"
echo -e "${cyan} Fail2Ban             ${NCT}: $status_fail2ban"
echo -e "${cyan} Crons                ${NCT}: $status_cron"
echo -e "${cyan} Vnstat               ${NCT}: $status_vnstat"
echo -e "${cyan} XRAYS Vmess TLS      ${NCT}: $status_tls_v2ray"
echo -e "${cyan} XRAYS Vmess None TLS ${NCT}: $status_nontls_v2ray"
echo -e "${cyan} XRAYS Vless TLS      ${NCT}: $status_tls_vless"
echo -e "${cyan} XRAYS Vless None TLS ${NCT}: $status_nontls_vless"
echo -e "${cyan} XRAYS Trojan         ${NCT}: $status_virus_trojan"
echo -e "${cyan} Shadowsocks          ${NCT}: $status_shadowsocks"
echo -e "${cyan} Websocket TLS        ${NCT}: $swstls"
echo -e "${cyan} Websocket None TLS   ${NCT}: $swstls"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NCT}"
echo ""
