#!/bin/bash
clear
wget -O /usr/bin/acc "https://raw.githubusercontent.com/basir96/scxnxx/main/menu/acc.sh" && chmod +x /usr/bin/acc
...
wget https://raw.githubusercontent.com/basir96/scxnxx/main/ssh/cf && chmod +x cf && sed -i -e 's/\r$//' cf && ./cf
...
sleep 2
clear
wget https://raw.githubusercontent.com/basir96/scxnxx/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
wget https://raw.githubusercontent.com/basir96/scxnxx/main/udp-custom/udp.sh && chmod +x udp.sh && ./udp.sh
#Instal Xray
clear
wget https://raw.githubusercontent.com/basir96/scxnxx/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/basir96/scxnxx/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/basir96/scxnxx/main/menu/versi  )
